  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden w-full">
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto px-4 sm:px-6 -mt-20">
        ...
        <p className="text-black text-lg sm:text-xl md:text-2xl lg:text-2.5xl font-medium mb-6 sm:mb-8 max-w-4xl mx-auto leading-relaxed px-2">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mt-12 sm:mt-16">
          <Button
            ...
            className="border-primary text-primary hover:bg-primary hover:text-primary-foreground hover-glow px-8 sm:px-12 py-4 sm:py-6 text-lg sm:text-xl font-semibold transition-all duration-300 scale-110 sm:scale-125"
          >
            Get in Touch
          </Button>
        </div>
